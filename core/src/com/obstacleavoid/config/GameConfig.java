...
// this class will only contain constants, so private constructor
public class GameConfig {
    ...
    public static final float OBSTACLE_SPAWN_TIME = 0.25F;    //every .25seconds, we are gonna spawn (release) an obstacle
    public static final float SCORE_MAX_TIME = 1.25f; //add score after every interval

    public static final int LIVES_START = 3; //world units
