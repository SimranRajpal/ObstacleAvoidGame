...
public class OptionsScreen extends ScreenAdapter
{
    ...
    @Override
    public void show() {
        viewport = new FitViewport(GameConfig.HUD_WIDTH, GameConfig.HUD_HEIGHT); //no camera passed, made internally
    ...
    private void createUi()
    {
        ...
        checkMark.setPosition(medium.getX() +50, medium.getY() + 40, Align.center); // default
    ...
    {
        log.debug("back()");
        game.setScreen(new MenuScreen(game)); //naviagting back to menu screen
    }
